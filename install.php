...
$territoryRawData=array(
	...
	array('The North', 'Land', 'Yes', 0, 350, 140, 175, 70),
	array('The Wall (West Coast)', 'Sea', 'No', 0, 400, 25, 200, 12),
	array('The Wall (East Coast)', 'Sea', 'No', 0, 550, 25, 275, 12),
	array('The Wall', 'Sea', 'Yes', 0, 475, 25, 238, 12),
	array('Last Hearth', 'Coast', 'No', 0, 560, 90, 280, 45),
	array('The Dreadfort', 'Coast', 'Yes', 0, 500, 200, 250, 100),
	array('White Knife', 'Land', 'No', 1, 430, 310, 215, 155),
	array('Karhold', 'Land', 'No', 0, 620, 215, 310, 108),
	...
	array('Harlaw', 'Coast', 'Yes', 3, 145, 775, 72, 388),
	array('Great Wyk', 'Coast', 'Yes', 3, 65, 785, 32, 392),
	array('Pyke', 'Coast', 'Yes', 3, 100, 815, 50, 408),
	...
	array('Western Riverrun', 'Coast', 'No', 0, 225, 855, 112, 428),
	...
	array('Faircastle', 'Coast', 'No', 0, 90, 940, 45, 470),
	array('Kayce', 'Coast', 'No', 5, 90, 980, 45, 490),
	array('Southern Riverrun', 'Land', 'No', 0, 280, 990, 140, 495),
	array('Stony Sept', 'Land', 'Yes', 0, 335, 1000, 168, 500),
	array('Blackwater Rush', 'Land', 'No', 0, 390, 990, 195, 495),
	array('Kingsroad South', 'Land', 'No', 0, 460, 980, 230, 490),
	array('Maidenpool (North Coast)', 'Sea', 'No', 0, 600,  905, 300, 452),
	array('Maidenpool (South Coast)', 'Sea', 'No', 0, 600,  950, 300, 475),
	array('Maidenpool', 'Sea', 'No', 0, 575, 925, 288, 462),
	...
	array('Crows Nest (North Coast)', 'Sea', 'No', 0, 600,  1230, 300, 615),
	array('Crows Nest (South Coast)', 'Sea', 'No', 0, 550,  1320, 275, 660),
	array('Crows Nest', 'Sea', 'No', 0, 565,  1270, 282, 635),
	array('Southshield', 'Coast', 'Yes', 0, 100,  1250, 50, 625),
	...
	array('Estermont', 'Coast', 'No', 0, 715,  1310, 358, 655),
